...
<a class="navbar-brand" href="#">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="prevention.php">Prevention</a>
  </li>
  <li class="nav-item">
    ...
    <div class="container bg-light p-2 my-2 text-center">
        ...
        <p class="text-bold">Ways to prevent Covid19!!!</p>
    </div>
    
    <div class="embed-responsive embed-responsive-4by3">
      <iframe class="embed-responsive-item" src="https://www.medicalnewstoday.com/articles/coronavirus-prevention#hand-washing" ></iframe>
    </div>
