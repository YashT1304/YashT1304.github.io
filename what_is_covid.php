...
<a class="navbar-brand" href="#">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="what_is_covid.php">What is Covid-19?</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <div class="container bg-light p-2 my-2 text-center">
        ...
        <p class="text-bold">What is Covid-19?</p>
    </div>
    
    <div class="embed-responsive embed-responsive-4by3">
      <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/sHP0UIdZyI4?autoplay=1" allowfullscreen></iframe>
    </div>
